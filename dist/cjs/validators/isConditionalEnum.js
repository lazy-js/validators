...
exports.ConditionalEnumConstraint = void 0;
exports.IsConditionalEnum = IsConditionalEnum;
...
exports.ConditionalEnumConstraint = ConditionalEnumConstraint;
exports.ConditionalEnumConstraint = ConditionalEnumConstraint = __decorate([
    (0, class_validator_1.ValidatorConstraint)({ name: 'conditionalEnum', async: false })
], ConditionalEnumConstraint);
// Method 2: Custom Decorator Function - updated with custom messages per key
function IsConditionalEnum(conditionProperty, enumMap, validationOptions) {
